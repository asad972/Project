...
<div class="container" align="center">
	...
	<form>
		...
		<label></label><input onblur="valid6()" type="password" id="password" placeholder="Enter Password">
		<label></label><input onblur="valid7()" type="password" id="password" placeholder="Re-enter Password">
		
		<button type="button" class="reset" onclick="Reset()">Reset</button><br>
		<p id="wrg" style="color: #FE1417 "></p>
	</form>
...
var pswrd;
	...
	{	
		...
		{
			document.getElementById("pp").innerHTML="invalid";
			fl6=0;
		}
	}
	...
	function valid7()
	{	
			var regpass1= /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})/
			pswrd1 =document.getElementById("password1").value;
			if(regname.test(pswrd) && pswrd==pswrd1)
		{
			document.getElementById("pp").innerHTML="valid";
			fl6=1;
		}
